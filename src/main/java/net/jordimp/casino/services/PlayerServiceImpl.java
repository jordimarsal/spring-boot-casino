...
public class PlayerServiceImpl implements PlayerService {
  ...
  public Player findByUUID(String uuid) {
    return playerRepository.findById(uuid).orElseThrow(() -> new PlayerNotFoundException(uuid));
  }
  ...
  public boolean logout(String uuid) {
    Player player =
        playerRepository.findById(uuid).orElseThrow(() -> new PlayerNotFoundException(uuid));
