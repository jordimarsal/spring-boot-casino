...
public class BetE2ETests {
  ...
  void testCompleteBetFlow() {
    ...
    ResponseEntity<Player> loginResponse =
        restTemplate.postForEntity("/api/casino/logon", player, Player.class);
    ...
    ResponseEntity<Bet> betResponse =
        restTemplate.postForEntity("/api/casino/bet/" + playerUuid, bet, Bet.class);
  ...
  void testPlayerNotFoundFlow() {
    ...
    ResponseEntity<String> response =
        restTemplate.getForEntity("/api/casino/get/" + nonExistentUuid, String.class);
  ...
  void testLoginAndLogoutFlow() {
    ...
    ResponseEntity<String> loginResponse =
        restTemplate.postForEntity("/api/casino/logon", player, String.class);
    ...
    ResponseEntity<String> logoutResponse =
        restTemplate.postForEntity("/api/casino/logout/" + playerUuid, null, String.class);
